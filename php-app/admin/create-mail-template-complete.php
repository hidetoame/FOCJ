...
// テンプレート読み込み
$html = file_get_contents('/var/www/html/templates/member-management/B6_create-mail-template-complete.html');
...
// テンプレート名を表示
$templateName = $_SESSION['last_template_name'] ?? '新規テンプレート';
